...
export class Region {
    ...
    pick(localX, localY) {
        // **** YOUR CODE HERE ****
        return localX >= 0 && localX <= this.w // check if the x position is within the region
            && localY >= 0 && localY <= this.h; // check if the y position is within the region
    }
    //. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
    ...
    draw(ctx, showDebugFrame = false) {
        ...
        if (this.loaded && !this.loadError && this.image) {
            // **** YOUR CODE HERE ****
            //If there is an image, draw it at the position of the region
            if (this.image) {
